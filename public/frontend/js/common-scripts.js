...
//    sidebar toggle
    ...
    function togglesidebar(wSize){
        // bigger than ipad
        if (wSize > 768) {
            if ($('#nav-accordion').hasClass("closed") === true) {
                $('#sidebar').css({'margin-left': '0px'});
                $('#nav-accordion').removeClass('closed');
            }
            else{
            ...
            if ($('#nav-accordion').hasClass("closed") === true) {
                $('#nav-accordion').slideDown();
                $('#nav-accordion').removeClass('closed');
            }
            else{
                $('#nav-accordion').slideUp();
                $('#nav-accordion').addClass('closed');
            }
        }
    }
