...
<div class="row"><!-- row -->
    <div class="col-md-12"><!-- col -->
        <p><a class="btn btn-default" href="{{ url('admin/autorites/'.$level.'/'.$canton->id) }}"><i class="fa fa-reply"></i> &nbsp;Retour à la liste des glossaires</a></p>
    </div>
</div>
<!-- start row -->
<div class="row">
    ...
    <div class="col-md-12">
        <div class="panel panel-midnightblue">
            ...
            <!-- form start -->
            <form data-validate-parsley action="{{ url('admin/autorite') }}" method="POST" class="form-horizontal" >
            {!! csrf_field() !!}
                ...
                <div class="panel-body event-info">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            {!! Form::textarea('siege',null, array('class' => 'form-control redactorSimple', 'cols' => '50' , 'rows' => '6' )) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            {!! Form::textarea('siege_de',null, array('class' => 'form-control redactorSimple', 'cols' => '50' , 'rows' => '6' )) !!}
                        </div>
                    </div>
